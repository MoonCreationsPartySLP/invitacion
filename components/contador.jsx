...
/*return (
  <div className="w-full text-center mt-8 space-y-3">
    ...
    {/* Fecha */}
    <div className="text-sm tracking-widest text-stone-700 font-TuFuenteLigera">
      JUNIO
    </div>

    {/* Día central */}
    <div className="text-6xl md:text-7xl font-TuFuenteSeriftext-stone-700">
      27
    </div>
    ...
    {/* Subtítulo */}
    <div className="mt-6 text-stone-600 tracking-[0.3em] font-TuFuenteLigera">
      FALTAN
    </div>

    {/* Contador estilizado */}
    <div className="flex justify-center gap-8 md:gap-12 mb-4 text-stone-700 font-TuFuenteLigera">
