...
export default function WeddingCard() {
    ...
    try {
      ...
      element.innerHTML = `
        <div style="text-align: center; font-family: 'Cormorant Garamond', serif;">
          <img src="/elegant-wedding-invitation-card-with-ampersand-mon.jpg" alt="Wedding Invitation" style="width: 100%; max-width: 600px; margin-bottom: 40px;" crossorigin="anonymous" />
  ...
  return (
    ...
    >
      ...
      <audio ref={audioRef} loop src="/audio/wedding-music.mp3" />
          ...
          <div style={{ perspective: "2000px" }} className="w-full">
            ...
            >
              ...
              <button onClick={handleOpenEnvelope} className="envelope-button" aria-label="Open envelope">
                <img src="/sello.png" alt="Open invitation" className="w-full h-full object-contain" />
              </button>
              {!envelopeOpened && (
